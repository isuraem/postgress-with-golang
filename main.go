...
import (
	...
	"github.com/isuraem/postgress-with-golang/models"
	"github.com/isuraem/postgress-with-golang/storage"
...
func (r *Repository) SetupRoutes(app *fiber.App) {
	...
	api.Put("/update_book/:id", r.UpdateBook) // Add this line for the update route
}
